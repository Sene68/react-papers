        ...
        <div className="w-full h-screen bg-[#fafafa]">
            <div className="absolute translate-x-[-50%] translate-y-[-50%] top-1/2 left-1/2">
                ...
                <div className="bg-white p-[20px] mt-[40px] flex justify-around shadow-lg">
                    <button className="w-[25px] h-[25px] border-[3px] border-solid border-[#dddddd] outline-none rounded-full bg-[#3498db]"></button>
                    <button className="w-[25px] h-[25px] border-[3px] border-solid border-[#dddddd] outline-none rounded-full bg-[#ff1756]"></button>
                    <button className="w-[25px] h-[25px] border-[3px] border-solid border-[#dddddd] outline-none rounded-full bg-[#1cb65d]"></button>
                    <button className="w-[25px] h-[25px] border-[3px] border-solid border-[#dddddd] outline-none rounded-full bg-[#8e44ad]"></button>
                    <button className="w-[25px] h-[25px] border-[3px] border-solid border-[#dddddd] outline-none rounded-full bg-[#f4b932]"></button>
                </div>
            </div>
        </div>
